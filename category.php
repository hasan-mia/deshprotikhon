<?php get_header(); ?>
  ...
  <!-- =======================
        Main Body Section
    ======================== -->
<div class="container" id="lead-sec">
  <div class="row my-2" id="cat-left">
   ...
   <?php if (have_posts()): ?>
    <div class="col-md-9 col-sm-12 col-12">
      ...
      <section>
        <div class="cat-lead-news my-2">
          <div class="row">
            <div class="col-md-8 col-sm-12 col-12 my-3" id="cat-lead">
              <?php
    ...
    <!-- End Body Part Col -->
  <?php   else:
      echo "<h2 style='color:red; text-align:center;margin:10% 0 10% 18%; font-family:SolaimanLipi;'> দুঃক্ষিত! এই ক্যাটাগরিতে কোন পোস্ট নেই... </h2>";
    endif; ?>
