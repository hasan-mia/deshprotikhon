  ...
  <div class="container">
    ...
    <div class="row">
      <!-- ===================
        Start Main Body Part
      ==================== -->
      <div class="col-md-9 col-sm-12 col-12 my-1">
        ...
        <div class="row">
          ...
          <div class="col-md-4 col-sm-12 col-12">
            <div class="cat-content my-1" id="archive">
          ...
          <!-- End content column -->
          <?php  endwhile;
        else:  echo "<h2 style='color:red; text-align:center;margin:10% 0 10% 5%; font-family:SolaimanLipi;'> দুঃক্ষিত! কোন পোস্ট পাওয়া যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন... </h2>";
          endif;  ?>
        </div>
        <!-- End row -->
      </div>
     ...
     Sidebar Section
    ============== -->
      <div class="col-md-3 col-sm-12 col-12 my-1">
