...
<div class="container" id="lead-sec">
  <div class="row">
    <!-- ========Body Part======= -->
    <div class="col-md-9 col-sm-12 col-12" id="full-single-body">
                ...
                <div class="col-md-6 col-sm-12 col-12">
                  <div class="single-social">
                    <ul class="share-icon">
                      ...
                      <li> <a href="https://twitter.com/share?url=<?php the_permalink();?>&t=<?php the_title(); ?>" target="_blank"> <i class="fab fa-twitter"></i> </a> </li>
